...
class GetCompetitionInfoByTeamIDUseCase implements UseCase<DataState<TeamWithProject>, String>{
  final CompetitionRepository _competitionRepository;
  
  GetCompetitionInfoByTeamIDUseCase(this._competitionRepository);
  
  @override
  Future<DataState<TeamWithProject>> call({String? params}) {
    return _competitionRepository.getCompetitionInfoByTeamID(params!);
  }
}