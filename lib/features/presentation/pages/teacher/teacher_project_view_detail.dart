...
class TeacherProjectViewDetailPage extends StatefulWidget {
  ...
  @override
  State<TeacherProjectViewDetailPage> createState() => _TeacherProjectViewDetailPageState();
}

class _TeacherProjectViewDetailPageState extends State<TeacherProjectViewDetailPage> {
  @override
  Widget build(BuildContext context) {
    // Get the first team info (assuming there's at least one)
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    // 作品狀態
                    _buildInfoRow("作品狀態:", team.workSate),
                    const SizedBox(height: 10),
                    ...
                    // 隊伍名稱
                    _buildInfoRow("隊伍名稱:", team.teamName),
                    const SizedBox(height: 10),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(team.workAbstract,style: const TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                      ],
                    ),
                    const SizedBox(height: 10),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(team.sdgs.join("  "),style: const TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                        ), 
                      ],
                    ),
                    const SizedBox(height: 10),
